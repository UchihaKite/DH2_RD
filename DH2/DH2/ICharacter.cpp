...
ICharacter::ICharacter(sf::Vector2f pos, sf::Vector2f size) : GameObject(pos, size)
{
	m_Name = "BaseCharacter"; //Make a randomizer or let the Player type their desired name
	m_Class = "BaseClass"; //Player will choose class or we can randomize. This is intended to be interchangable
